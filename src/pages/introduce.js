      ...
      <main>
        ...
        <section className="academicSection">
          <div className="container aboutLead">
            ...
            <div><span className="academicEyebrow">BIOGRAPHY</span><h2>{profile.nameZh} <small>{profile.nameEn}</small></h2><p>{profile.bio}</p><p>本科阶段的智能车竞赛与嵌入式项目，让我开始关注感知算法如何在真实系统中稳定工作。当前，我在湘潭大学攻读控制科学与工程硕士学位，将主要精力投入遥感目标检测、少样本语义分割与视觉基础模型研究。</p><div className="aboutLinks"><a href={`mailto:${profile.email}`}>Email</a><a href={profile.github}>GitHub</a><Link to="/scholar">学术成果</Link></div></div>
          </div>
        </section>
